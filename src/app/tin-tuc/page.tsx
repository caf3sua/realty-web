  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-12">
      ...
      <div className="border-b border-neutral-900 pb-8">
        <span className="text-amber-500 text-xs font-bold tracking-widest uppercase">Tin tức & phân tích</span>
        <h1 className="text-4xl font-serif text-white font-semibold mt-2">Tin Tức Bất Động Sản</h1>
          ...
          >
            ...
            <div className="p-6 flex flex-col justify-between flex-grow gap-4">
              <div className="space-y-3">
                ...
                <h2 className="text-base font-serif font-bold text-white group-hover:text-amber-400 transition-colors line-clamp-2 leading-snug">
                  {news.title}
                </h2>
              ...
              <span className="text-xs text-amber-400 font-semibold flex items-center gap-1 group-hover:gap-2 transition-all mt-auto">
                Chi tiết bài viết

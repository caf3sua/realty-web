...
export default async function HotBrandPage({ params }: Props) {
  ...
  // Filter products by developer name and is_hot
  let brandProducts: Product[] = [];
  try {
    brandProducts = await api.getProducts({ developer: brandInfo.developerName, is_hot: true });
  } catch (error) {
    console.error("Error loading hot products for brand:", error);
  }
            ...
            {brandProducts.map((product) => (
              ...
              >
                <div className="relative h-56 w-full overflow-hidden">
                  ...
                  <span className="absolute top-4 right-4 bg-brand-cream text-brand-brown text-[10px] font-bold px-2.5 py-0.5 rounded-none border border-brand-gray-medium">
